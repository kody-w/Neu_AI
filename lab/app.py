...
def sms_reply():
    ...
    response, _ = assistant.get_response(message_body)
...
def chat():
    ...
    if user_input is not None and user_input.strip() != "":
        assistant_response, skill_logs = assistant.get_response(
            user_input.strip())
...
def stream():
    def event_stream():
        while True:
            ...
            assistant_response, _ = assistant.get_response(user_input)
...
def update_ai_context(conversation_log):
    ...
    # ...
    print("Updating AI context with conversation log...")
