...
class StoryGeneratorSkill(BasicSkill):
    def __init__(self):
        ...
        self.metadata = {
            "name": self.name,
            "description": "Generates a complete story using Azure OpenAI's API, following a multi-step process, and saves each stage to separate files.",
            "parameters": {
                "type": "object",
                "properties": {
                    "genre": {
                        "type": "string",
                        "description": "The genre of the story to generate"
                    },
                    "idea": {
                        "type": "string",
                        "description": "The initial story idea"
                    },
                    "num_chapters": {
                        "type": "integer",
    ...
    def load_api_config(self):
        try:
            ...
            self.endpoint = f"{api_keys['azure_openai_endpoint']}openai/deployments/gpt-4o/chat/completions?api-version={self.api_version}"
    ...
    def perform(self, genre, idea, num_chapters=7):
        try:
    ...
    def azure_openai_call(self, messages, temperature=0.7, max_tokens=2000):
        headers = {
        ...
        try:
            ...
            if "429" in str(e):
                ...
                return self.azure_openai_call(messages, temperature, max_tokens)
            else:
                raise

    def generate_story_idea(self, genre, idea):
        messages = [
...
"""}
        ...
        return self.azure_openai_call(messages)

    def generate_story_outline(self, genre, idea_file):
...
"""}
    ...
    def generate_chapter_summaries(self, genre, outline_file):
...
"""}
    ...
    def generate_full_story(self, genre, summaries_file, num_chapters):
...
"""}
            ...
            chapter_content = self.azure_openai_call(messages)
