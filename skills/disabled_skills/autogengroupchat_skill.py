    ...
    def __init__(self):
        ...
        self.metadata = {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "chat_name": {"type": "string", "description": "The assistant will provide an appropriate value for chat_name based on the context or user input."},
                    "task_description": {"type": "string", "description": "The assistant will provide an appropriate value for task_description based on the context or user input."},
                    "participants": {"type": "string", "description": "The assistant will provide an appropriate value for participants based on the context or user input."},
                    "max_turns": {"type": "string", "description": "The assistant will provide an appropriate value for max_turns based on the context or user input."},
                    "user_proxy": {"type": "string", "description": "The assistant will provide an appropriate value for user_proxy based on the context or user input."},
                    "manager": {"type": "string", "description": "The assistant will provide an appropriate value for manager based on the context or user input."},
                    "default_model": {"type": "string", "description": "The assistant will provide an appropriate value for default_model based on the context or user input."},
                    "default_azure_deployment": {"type": "string", "description": "The assistant will provide an appropriate value for default_azure_deployment based on the context or user input."},
                    "allow_early_termination": {"type": "string", "description": "The assistant will provide an appropriate value for allow_early_termination based on the context or user input."}
                },
                "required": ['chat_name', 'task_description', 'participants', 'max_turns', 'user_proxy', 'manager', 'default_model', 'default_azure_deployment', 'allow_early_termination']
            }
        }
        super().__init__(name=self.name, metadata=self.metadata)

    def perform(self, chat_name: str, task_description: str, participants: list, max_turns: int, user_proxy: dict = None, manager: dict = None, default_model: str = 'gpt-4o', default_azure_deployment: str = 'gpt-4o', allow_early_termination: bool = True) -> str:
        """
        A skill to create and manage ultra-customizable AutoGen-based group chats with per-agent parameter tuning and early termination capability.

        Args:
            chat_name (str): The assistant will provide an appropriate value based on the context or user input.
            task_description (str): The assistant will provide an appropriate value based on the context or user input.
            participants (list): The assistant will provide an appropriate value based on the context or user input.
            max_turns (int): The assistant will provide an appropriate value based on the context or user input.
            user_proxy (dict = None): The assistant will provide an appropriate value based on the context or user input.
            manager (dict = None): The assistant will provide an appropriate value based on the context or user input.
            default_model (str = 'gpt-4o'): The assistant will provide an appropriate value based on the context or user input.
            default_azure_deployment (str = 'gpt-4o'): The assistant will provide an appropriate value based on the context or user input.
            allow_early_termination (bool = True): The assistant will provide an appropriate value based on the context or user input.
        ...
        try:
            ...
            return f"An error occurred while executing the AutoGenGroupChat skill: {str(e)}"
